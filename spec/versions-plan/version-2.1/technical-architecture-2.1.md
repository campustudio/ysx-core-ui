...
| `ysx-core-ui`            | 元思想核心前端（已集成调用明镜后端） | `/Users/chrisdu/ysx-core-ui`                     |
...
| https://www.metamindpt.com/  | 元思想域名服务器（阿里云 OSS） |
...
4. **系统集成**：将明镜系统集成到元思想的明镜模块
5. **UI 对齐**：明镜 UI 风格与主题对齐元思想最新标准
