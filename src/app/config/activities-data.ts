...
export const ACTIVITIES: Record<string, Activity> = {
  "hp-1": {
    ...
    coverImage: "/images/img-157079965008.jpg",
    description:
  ...
  "hp-2": {
    ...
    price: "体验课 ¥0 · 会员制",
    participants: "本周可预约",
    coverImage: "/images/img-176389096539.jpg",
    description:
      "元境中心是元感知的线下体验空间，坐落在西溪湿地旁的安静角落。这里没有课表的压力，没有社交的焦虑，只有一个可以安静待着的地方。你可以来这里做一次呼吸引导，也可以只是坐着发呆。",
    highlights: [
      "自然环境：紧邻西溪湿地，四季变换可感",
      "自由空间：无课表压力，来去自如",
      "引导服务：资深引导师在场，需要时可预约",
  ...
  "hp-3": {
    ...
    price: "¥99（早鸟价 ¥69）",
    participants: "限30人",
    coverImage: "/images/img-175855522590.jpg",
    description:
      "成长工作坊是元感知的主题工作坊系列。本期主题：「身体的记忆」——探索情绪如何存储在身体中，以及如何通过身体练习来释放积压的情绪。适合对自我成长感兴趣的朋友。",
    highlights: [
      "理论 + 体验：不只是听，更是亲身感受",
