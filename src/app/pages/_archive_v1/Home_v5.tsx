...
export function Home({
  onNavChange,
  // 暂时在此处默认 true 并提供模拟数据，以便你能直接在右侧预览出效果。
  // 实际接入公众号后，未登录时传入 isLoggedIn={false} 即可什么都不显示。
  isLoggedIn = true,
  userInfo = {
    name: "感知者",
    ...
    >
      ...
      <span
        style={{
          ...
          textAlign: "center",
          textShadow: "0 1px 0 rgba(255,255,255,0.8), 0 0 1px rgba(0,0,0,0.1)", // 上方微暗，下方高亮，形成雕刻凹陷
          lineHeight: 1.2,
        }}
      >
        {axis.title}
